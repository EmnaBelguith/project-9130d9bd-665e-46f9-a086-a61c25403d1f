...
RUN python -c "import sys; sys.path.insert(0, '/app/talkshow-extended'); try:     from talkshow.app import create_app;     print('create_app found and importable!'); except ImportError as e:     print(f'ImportError: {e}');     sys.exit(1)"
